...
class LanguageManager:
    ...
    def load_languages(self):
        ...
        if self.default_language not in self.languages:
            print(f"✗ Critical: Default language '{self.default_language}' not loaded")
    ...
    def _create_fallback_language(self):
        ...
        return {
            "app": {"name": "CodeInsight", "description": "Your code analysis companion"},
            "navigation": {"home": "Home", "dashboard": "Dashboard", "login": "Login", "logout": "Logout", "profile": "Profile"},
            "auth": {"welcome": "Welcome", "login_with_github": "Login with GitHub", "login_with_gitlab": "Login with GitLab"},
